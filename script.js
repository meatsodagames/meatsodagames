...
const landNav = document.getElementById("landingNav");

const observer = new IntersectionObserver(([entry]) => {
    if (entry.isIntersecting) {
        header.classList.remove("reveal");
        banner.classList.remove("hide");
        landNav.classList.remove("hide");
...
const landingContactButton = document.getElementById("landingContact");
