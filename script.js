...
const description = {
    ...
    glitchtrix: ["LHÍ assignment for a audio visual class. I programmed an interactive and reactive music visualizer using Touch Designer. Song is Le gout Des Cendres by Kompromat."],
